...
export const { usePostCaseMutation, useGetAllCaseQuery, useGetCaseQuery, useUpdateCaseMutation, useGetCaseIdQuery, useUpdateResultMutation } = caseApiSlice;
