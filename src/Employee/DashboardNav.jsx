...
function SideNav() {
  ...
  useEffect(() => {
    if (error) {
      ...
      const adm = employees.find(
        (employee) => employee.cid === userInfo.user.username
      );
      setUser(adm);
    }
        ...
        <div className="side-nav-item-container">
          ...
          <div className="nav-items">
            ...
            <Link
              ...
              className={`nav-link ${
                location.pathname === "/employeeDataManagement"
                  ? "nav-active"
                  : ""
              }`}
            >
      ...
      <div className="admin-logout-container" style={{ marginBottom: "1vh" }}>
        ...
        >
          ...
          <div className="user-detail">
            <div className="user-detail-header">Employee</div>
