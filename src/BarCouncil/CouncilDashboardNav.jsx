...
import "./css/CouncileSideNav.css";
    ...
    <div className="lawyer-sidenav-container">
      <div className="lawyer-side-nav-logo-container">
        ...
        <div className="lawyer-logo-word-container">
          ...
          <div className="lawyer-logo-word">Bar Council Dashboard</div>
        </div>
      </div>
      <div className="lawyer-side-nav-item-container">
        ...
        <div className="lawyer-nav-items">
          <Link
            to="/barcouncil"
            className={`nav-link ${location.pathname === "/barcouncil" ? "nav-active" : ""}`}
          >
            <div className="lawyer-nav-item-container">
              <svg
                ...
                width="28px"
                fill={location.pathname === "/barcouncil" ? "#15605C" : "#F1ECE4"}
              >
              ...
              <div className="lawyer-nav-item-name">Cases Overview</div>
            </div>
          </Link>
          <Link
            to="/lawyerRegistered"
            className={`nav-link ${location.pathname === "/lawyerRegistered" ? "nav-active" : ""}`}
          >
            <div className="lawyer-nav-item-container">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                viewBox="0 -960 960 960"
                width="28px"
                fill={location.pathname === "/lawyerRegistered" ? "#15605C" : "#F1ECE4"}
              >
              ...
              <div className="lawyer-nav-item-name">Lawyers Registered</div>
            </div>
          </Link>
        </div>
        <div className="admin-logout-container">
          ...
          <button className="admin-logout-btn" onClick={logOutHandler}>Logout</button>
        </div>
      </div>
    </div>
  );
