...
import "./css/CouncilDashboard.css"
import CouncilSideNav from "./CouncilDashboardNav";
import { Modal } from "@mui/material";
import AssignedLwayerPopup from "../components/AssignedLawyerPopup";


const LawyerRegistered = () => {
    ...
    return (
        <div className="dashboard-container">
            <Modal open={open} onClose={handleClose}>
                <AssignedLwayerPopup onClose={handleClose} />
            </Modal>
            <CouncilSideNav />
            <div className="dashboard-content">
                <div className="dashboard-header">Case Overview</div>
...
export default LawyerRegistered;